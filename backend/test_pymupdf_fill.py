...
# Need to reload original coords since we overwrote the Y for pdf-lib earlier.
...
for section, fields in schema.items():
    ...
    for field_key, value in fields.items():
        ...
        if best_match:
            ...
            # Draw text
            # We want to place it to the right of the label
            # Typical labels end around x=200, but some are long.
            # To make it look like it's filled exactly on the line:
            # We look at the line "GIVEN NAME - " and put it after the "- "
